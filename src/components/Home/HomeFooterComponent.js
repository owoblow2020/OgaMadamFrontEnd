                                        ...
                                        <div className="col-lg-3 column">
                                            <div className="widget">
                                                <div className="about_widget">
                                                    <div className="logo">
                                                    <Link to=""><img src="http://placehold.it/152x25" alt="" /></Link>
                                                    </div>
                                                    ...
                                                    <div className="social">
                                                        ...
                                                        <Link to=""><i className="la la-linkedin" /></Link>
                                                        <Link to=""><i className="la la-pinterest" /></Link>
                                                        <Link to=""><i className="la la-behance" /></Link>
                                                    </div>
                                                </div>{/* About Widget */}
                                            </div>
                                        </div>
