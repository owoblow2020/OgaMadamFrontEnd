...
class HeaderMenu2 extends Component {
    state = {}
    render() {
        return (
                    ...
                    <div className="container">
                        ...
                        <div className="btn-extars">
                            ...
                            <ul className="account-btns">
                                <li className="signup-popup"><a href="/" title><i className="la la-key" /> Sign Up</a></li>
                                <li className="signin-popup"><a href="/" title><i className="la la-external-link-square" /> Login</a></li>
                            </ul>
                        </div>{/* Btn Extras */}
                        <nav>
                            <ul>
